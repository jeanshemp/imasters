...
public class Exercicio4 {
	...
	public static void main(String[] args) {
        ...
        if (notaAv1 > notaAv2 && notaAv1 > notaAv3){
        	System.out.println ("A Nota da Avaliação 1 foi a maior nota, Parabens, Nota = " + notaAv1);
        }
        
        if (notaAv2 > notaAv1 && notaAv2 > notaAv3){
        	System.out.println ("A Nota da Avaliação 2 foi a maior, Parabens! Nota = " + notaAv2);
        }
        
        if (notaAv3 > notaAv2 && notaAv3 > notaAv1){
        	System.out.println ("A Nota da Avaliação 3 foi a maior, Parabens! Nota = " + notaAv3);
        }
        
        if (notaAv1 < notaAv2 && notaAv1 < notaAv3){
        	System.out.println ("A Nota da Avaliação 1 foi a menor. Nota = " + notaAv1);
        }
        
        if (notaAv2 < notaAv1 && notaAv2 < notaAv3){
        	System.out.println ("A Nota da Avaliação 2 foi a menor. Nota = " + notaAv2);
        }
        
        if (notaAv3 < notaAv2 && notaAv3 < notaAv1){
        	System.out.println ("A Nota da Avaliação 3 foi a menor. Nota = " + notaAv3);
        }
